...
- Implement build & deploy commands in Makefile.
- Use Docker/K8s for consistent environments.
- Docker setup must include Dockerfile and docker-compose.yml with all used services described.
...
- Missing or incomplete Docker/Docker-compose setup.